const idlFactory = ({ IDL }) => {
    ...
    const Result_3 = IDL.Variant({ 'ok' : Ogy_Token, 'err' : OrigynError });
    ...
    const Result_2 = IDL.Variant({ 'ok' : IDL.Null, 'err' : CollectionErr });
    ...
    return IDL.Service({
      ...
      'addWhitelist' : IDL.Func(
          [IDL.Principal, IDL.Vec(AccountIdentifier__1)],
          [],
          [],
        ),
      'add_import_collection_price' : IDL.Func(
          [TokenSpec__1, IDL.Nat],
          [],
          ['oneway'],
        ),
      'auditCollection' : IDL.Func([IDL.Principal, IDL.Text], [IDL.Bool], []),
      'balance' : IDL.Func([IDL.Opt(IDL.Principal), TokenSpec__1], [IDL.Nat], []),
      ...
      'claim_origyn' : IDL.Func(
          [IDL.Principal, IDL.Nat64],
          [IDL.Vec(Result_3)],
          [],
        ),
      'delCreator_whitelist' : IDL.Func(
          [IDL.Vec(IDL.Principal)],
          [IDL.Vec(IDL.Principal)],
          [],
        ),
      ...
      'get_actor_pid' : IDL.Func([], [IDL.Principal], ['query']),
      'get_import_collection_price' : IDL.Func(
          [],
          [IDL.Vec(IDL.Tuple(TokenSpec__1, IDL.Nat))],
          ['query'],
        ),
      'importCollection' : IDL.Func([CollectionInfo], [Result_2], []),
      'importCollectionWithToken' : IDL.Func(
          [CollectionInfo, TokenSpec__1, IDL.Opt(IDL.Principal)],
          [Result_1],
          [],
        ),
      ...
      'setICPSettlements' : IDL.Func(
          [IDL.Nat, User__1, IDL.Nat64, IDL.Nat64],
          [],
          [],
        ),
