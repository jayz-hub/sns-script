const idlFactory = ({ IDL }) => {
    ...
    const Event = IDL.Record({
      ...
      'height' : IDL.Nat64,
      'toAid' : IDL.Opt(AccountIdentifier__1),
      'collection' : IDL.Principal,
      'date' : Time,
      'from' : IDL.Opt(IDL.Principal),
      'item' : TokenIdentifier,
      'memo' : IDL.Nat64,
      'fromAid' : IDL.Opt(AccountIdentifier__1),
    ...
    return IDL.Service({
      ...
      'getEventByMemo' : IDL.Func([IDL.Nat64], [IDL.Opt(Event)], ['query']),
